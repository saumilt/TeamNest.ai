				...
				<div className="min-w-0 flex-1">
					...
					{chat.project_folder_id && (
						<button
							...
							className="mt-0.5 inline-flex items-center gap-1 h-5 px-2 rounded-full bg-brand-tint text-brand text-[11px] font-medium hover:bg-brand/30"
						>
							<span>🗂</span>
					...
					{chat.type === "group" && !chat.linked_dev_project && onSpinUpDevOs && (
						<button
							...
							className="mt-0.5 ml-1 inline-flex items-center gap-1 h-5 px-2 rounded-full bg-surface-2 text-ink-dim hover:bg-yellow-400/15 hover:text-yellow-200 ring-1 ring-hairline hover:ring-yellow-400/30 text-[11px] font-medium disabled:opacity-60"
						>
							<Rocket className="w-3 h-3" />
